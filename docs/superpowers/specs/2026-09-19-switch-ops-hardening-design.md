...
- **既存テスト 4 本**の書き換え (§7.1、v1.5 で 3 → 4)、runbook (`docs/operations/indicator-initial-set-deploy-2026-09-19.md`) の改訂。
...
| `tests/test_commands.py` | AC-12a〜AC-12c / AC-13 / AC-14a〜AC-14d を**追記**。**`:541` の spy だけ書き換える** (§7.1) |
